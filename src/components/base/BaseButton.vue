...
.btn--primary:disabled {
  cursor: not-allowed;
  background-color: var(--clr-lg300);
}
...
.btn--secondary:active:not([disabled]) {
  cursor: pointer;
  color: var(--clr-lg700);
  border: 1px solid var(--clr-lg700);
}
...
.btn--notification {
  width: var(--h-default);
  background: var(--clr-lg200) url(../../assets/img/Sprites.64af8f61.svg)
    no-repeat -781px -24px;
}
...
.btn--help {
  width: var(--h-default);
  background: url(../../assets/img/Sprites.64af8f61.svg) no-repeat -82px -138px;
}
...
.btn--close {
  width: var(--h-default);
  background: url(../../assets/img/Sprites.64af8f61.svg) no-repeat -137px -139px;
}
</style>
